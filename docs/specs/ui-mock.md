...
|        [Day 1]  Linking: minTurn=10m / radius=100m / ParentStation=ON          |
|--------------------------------------------------------------------------------|
| Blocks (上)                                                                      |
...
| Tabs: Import | Explorer | Blocks | Duties                                     |
+-------------------------------------------------------------------------------+
| Day: [Day 1 ▼]   Linking: minTurn=10m  radius=100m  ParentStation=ON          |
|--------------------------------------------------------------------------------|
| Trips Timeline                                                                |
...
- 右ペインで警告を即時表示（保存は可能）。
- 画面上部に現在の linking 設定を常時表示（minTurn, radius, ParentStation）。
