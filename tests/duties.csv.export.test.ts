...
test('buildDutiesCsv outputs rows with metadata and settings hash', () => {
  ...
  const expectedCsv = [
    ...
    'DUTY_001,1,BLOCK_001,TRIP_A,TRIP_B,DRIVER_A,2025-10-07T15:00:00.000Z,1989780b',
    'DUTY_001,2,BLOCK_001,TRIP_C,TRIP_C,DRIVER_A,2025-10-07T15:00:00.000Z,1989780b',
    'DUTY_EMPTY,1,,,,,2025-10-07T15:00:00.000Z,1989780b',
  ].join('\n');
