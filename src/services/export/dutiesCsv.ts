    ...
    segments.forEach((segment, index) => {
      rows.push(
        [
          ...
          segment.endTripId,
          segment.kind ?? 'drive',
          segment.kind === 'break' ? segment.breakUntilTripId ?? segment.endTripId : '',
          segment.kind === 'deadhead' && typeof segment.deadheadMinutes === 'number' ? String(segment.deadheadMinutes) : '',
          segment.kind === 'deadhead' ? segment.deadheadRuleId ?? '' : '',
          segment.kind === 'deadhead' ? segment.deadheadFromStopId ?? '' : '',
          segment.kind === 'deadhead' ? segment.deadheadToStopId ?? '' : '',
          driverId,
          generatedAt,
          settingsHash,
          violationsSummary,
